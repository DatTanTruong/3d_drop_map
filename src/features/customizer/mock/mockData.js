...
export const mockImages = [
  ...
  { id: 10, name: "road1_preview", address: "/mock/images/materials/road1.png" },
  { id: 11, name: "road2_preview", address: "/mock/images/materials/road2.png" },
  { id: 12, name: "road3_preview", address: "/mock/images/materials/road3.png" },
  { id: 13, name: "road4_preview", address: "/mock/images/materials/road4.png" },
  { id: 14, name: "mountain_preview", address: "/mock/images/accessories/mountain.png" },
];
...
export const mockModels = [
  ...
  { id: 10, name: "road1_model", address: "/mock/models/materials/road1.glb" },
  { id: 11, name: "road2_model", address: "/mock/models/materials/road2.glb" },
  { id: 12, name: "road3_model", address: "/mock/models/materials/road3.glb" },
  { id: 13, name: "road4_model", address: "/mock/models/materials/road4.glb" },
  { id: 14, name: "mountain_model", address: "/mock/models/accessories/mountain.glb" },
];
...
export const charms = [
  ...
  },
  {
    ...
    imageId: 10,
    modelId: 10,
    image: mockImages.find(img => img.id === 10),
    model: mockModels.find(model => model.id === 10),
    previewImage: "/mock/images/accessories/road1.png",
    modelPath: "/mock/models/accessories/road1.glb",
  },
  {
    id: 9,
    name: "road2",
    ...
    imageId: 11,
    modelId: 11,
    image: mockImages.find(img => img.id === 11),
    model: mockModels.find(model => model.id === 11),
    previewImage: "/mock/images/accessories/road2.png",
    modelPath: "/mock/models/accessories/road2.glb",
  },
  { id: 10,
    name: "road3",
    price: 3.0,
    imageId: 12,
    modelId: 12,
    image: mockImages.find(img => img.id === 12),
    model: mockModels.find(model => model.id === 12),
    previewImage: "/mock/images/accessories/road3.png",
    modelPath: "/mock/models/accessories/road3.glb",
  },
  { id: 11,
    name: "road4",
    price: 3.0,
    imageId: 13,
    modelId: 13,
    image: mockImages.find(img => img.id === 13),
    model: mockModels.find(model => model.id === 13),
    previewImage: "/mock/images/accessories/road4.png",
    modelPath: "/mock/models/accessories/road4.glb",
  },
  { id: 12,
    name: "mountain",
    price: 4.0,
    imageId: 14,
    modelId: 14,
    image: mockImages.find(img => img.id === 14),
    model: mockModels.find(model => model.id === 14),
    previewImage: "/mock/images/accessories/mountain.png",
    modelPath: "/mock/models/accessories/mountain.glb",
  },
];
